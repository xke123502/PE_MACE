...
class AtomicData(torch_geometric.data.Data):
    ...
    def __init__(
        ...
        field_scalar: Optional[torch.Tensor],  # [n_nodes, ]
    ):
        # Check shapes
        num_nodes = node_attrs.shape[0] # 原子数
        ...
        # 2024 1002 new fields
        assert field_scalar is None or field_scalar.shape == (num_nodes,)
        ...
        data = {
            ...
            "dipole": dipole,
            "charges": charges,
            "field_scalar": field_scalar, # 2024 1002 new fields
        }
        super().__init__(**data)
    ...
    def from_config(
        ...
        field_scalar = (
            torch.tensor(config.field_scalar, dtype=torch.get_default_dtype())
            if hasattr(config, 'field_scalar') and config.field_scalar is not None
            else None
        )
