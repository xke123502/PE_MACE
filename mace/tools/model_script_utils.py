...
def _build_model(
    ...
    if args.model == "MACE_Field":
        return modules.MACE_Field(
            **model_config,
            pair_repulsion=args.pair_repulsion,
            distance_transform=args.distance_transform,
            correlation=args.correlation,
            ...
            radial_type=args.radial_type,
            heads=heads,
            scalar_field_irreps=o3.Irreps(args.scalar_field_irreps),
        )
    if args.model == "ScalarMACE": #ScalarMACE
        return modules.ScalarMACE(
            **model_config,
        )
