...
#import mace.tools.model_script_utils
    ...
    for head, head_args in args.heads.items():
        ...
        if head_config.train_file.endswith(".xyz"):
            ...
            collections, atomic_energies_dict = get_dataset_from_xyz(
                ...
                field_scalar_key=head_config.field_scalar_key,  # new added
            )
...
if __name__ == "__main__":
    import os
    print("CUDA_VISIBLE_DEVICES in Python:", os.environ.get("CUDA_VISIBLE_DEVICES"))
    main()
