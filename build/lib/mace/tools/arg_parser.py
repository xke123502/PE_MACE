...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--field_scalar_key', type=str, default=None,
                    help='Key for scalar field data in the dataset')
    parser.add_argument('--scalar_field_irreps', type=str, default=None,
                    help='Irreps for scalar field input in MACE_Field model')
    parser.add_argument(
